...
class File extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'activities' => array(self::HAS_MANY, 'Activity', 'fileId'),
	...
	public function search()
	{
		...
		$criteria->compare('fpUrl',$this->fpUrl,true);
		$criteria->compare('boxId',$this->boxId,true);
		$criteria->compare('boxFileSize',$this->boxFileSize);
